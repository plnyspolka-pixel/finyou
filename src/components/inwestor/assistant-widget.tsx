 ...
 *
 * Interfejs jest nasz (polskie napisy, styl panelu) — gdy agent A3 ElevenLabs
 * jest skonfigurowany, odpowiada on, ale przez serwer
 * (sendInvestorAssistantMessage), a nie przez osadzony widget ElevenLabs.
 */
