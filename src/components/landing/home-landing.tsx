...
import { MarketingShell, type MarketingContact } from "@/components/marketing/shell";
import {
  Section,
  SectionHead,
  RoleCard,
...
/**
 * Pełna zawartość landinga finansowego ze strony głównej `/`.
 * Wydzielona do komponentu, żeby kopie landinga (np. /pawel — wersja
 * z telefonem operatora w headerze) współdzieliły treść z oryginałem.
 */
...
export function HomeLanding({
  ...
  return (
    <MarketingShell page="home" contact={contact}>
      <Hero />
