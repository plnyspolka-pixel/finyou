...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ref={ref}
    className={cn(
      // shrink-0 jest tu kluczowe: bez niego przy kilku zakładkach na wąskim
      // ekranie triggery ściskały się do zera, a ich whitespace-nowrap tekst
      // wychodził poza przycisk i nachodził na sąsiednie zakładki.
