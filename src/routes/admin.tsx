...
import { LayoutDashboard, Users, FileText, FolderOpen, PhoneCall, Briefcase, Send, Tag, Plug, Settings, LogOut, ShieldCheck, Mic, GraduationCap, Code2, Wand2, Receipt, BookOpen, Facebook, Mail, Search, Sparkles, Link2, TrendingDown, Eye, Bot, FileCheck, Menu, FileSignature, FlaskConical } from "lucide-react";
...
const groups: Group[] = [
  { items: [
    ...
    { to: "/admin/ab-tester", label: "A/B Tester Landingów", icon: FlaskConical },
  ] },
  {
