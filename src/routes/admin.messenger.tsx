...
import { MessageCircle, Send, RefreshCw, Search, ExternalLink, Bot, User as UserIcon } from "lucide-react";
    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between gap-3">
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-2xl font-semibold">Messenger / Instagram DM</h1>
        </div>
              ...
              <div className="flex items-center justify-between border-b pb-3 mb-3">
                ...
                {selectedLeadId && (
                  <Button asChild variant="outline" size="sm">
                    <Link to="/admin/klienci/$id" params={{ id: selectedLeadId }}>
