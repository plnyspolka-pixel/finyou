...
export const EMAIL_TEMPLATES: Record<number, Tpl> = {
  ...
  15:{ subject: "Nie musisz mieć wszystkiego od razu",
       body: (v) => `${greet(v)}\n\nWielu klientów czeka „aż uzbiera wszystkie papiery". To nie jest potrzebne — wniosek możesz dokończyć z tym, co masz teraz, a resztę dosyłamy spokojnie w trakcie.\n\n${cta(v)}${sig}` },
