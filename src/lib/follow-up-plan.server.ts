...
export const EMAIL_TEMPLATES: Record<number, Tpl> = {
  1: { subject: "Ponad 300 inwestorów czeka na Twój wniosek 🔥",
  ...
  2: { subject: "Sprawdź, ile wyniesie Twoja rata — 30 sekund",
  ...
  3: { subject: "Twoja rata może być NIŻSZA, niż myślisz",
  ...
  4: { subject: "Decyzja w 24 godziny — bez BIK i ZUS",
