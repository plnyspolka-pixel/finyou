  ...
  <Html lang="pl" dir="ltr">
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          Bez haseł, bez ściągania ich z karteczek, bez „nie pamiętam, którego użyłem na której stronie".
          W <Link href="https://financeyou.pl" style={link}>FinanceYou</Link> wystarczy jeden link — taki jak ten poniżej — żeby wrócić do swojego wniosku, swoich dokumentów i swojej sprawy.
        </Text>
        <Text style={text}>
          Kliknij przycisk poniżej w ciągu najbliższych kilkunastu minut. Później link wygaśnie, bo bezpieczeństwo Twoich danych jest dla nas ważniejsze niż wygoda.
        </Text>
        <Button style={button} href={confirmationUrl}>
          Zaloguj mnie do FinanceYou
        </Button>
        <Text style={text}>
          Po zalogowaniu zobaczysz dokładnie to, na czym skończyłeś — etap wniosku, status weryfikacji, kolejny krok.
        </Text>
        <Text style={text}>
          Chcesz najpierw się rozejrzeć? Wróć na{' '}
          <Link href="https://financeyou.pl" style={link}>financeyou.pl</Link> albo przeczytaj{' '}
          <Link href="https://financeyou.pl/blog" style={link}>blog FinanceYou</Link> — pokazujemy tam, jak nasi klienci wykorzystują kapitał z nieruchomości.
        </Text>
        <Text style={footer}>
