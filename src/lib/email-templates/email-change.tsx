  ...
  <Html lang="pl" dir="ltr">
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          Zmiana skrzynki to często znak, że coś się w życiu przesuwa — nowa praca, nowy etap firmy,
          nowy porządek w głowie. Cieszymy się, że chcesz zabrać{" "}
          <Link href="https://financeyou.pl" style={link}>
            FinanceYou
          </Link>{" "}
          ze sobą do nowej skrzynki.
        </Text>
        <Text style={text}>
          Dla bezpieczeństwa potrzebujemy jednego potwierdzenia, że to naprawdę Ty. Wcześniej
          logowałeś się jako{" "}
        ...
        <Text style={text}>
          Po potwierdzeniu wszystkie wiadomości — od statusu wniosku po przypomnienia o dokumentach
          — zaczną przychodzić na nowy adres. Stary przestanie działać do logowania.
        </Text>
        <Text style={text}>
          ...
          , a najnowsze wpisy i poradniki na{" "}
        ...
        <Text style={footer}>
          Jeśli to nie Ty prosiłeś o zmianę adresu, zignoruj tę wiadomość — zmiana nie zostanie
          wykonana.
        </Text>
        <Link
